...
namespace ECM.Controllers
{
    ...
    public class BaseCharacterController : MonoBehaviour
    {
        ...
        protected virtual void Animate() {
            ...
            var forwardAmount = Mathf.InverseLerp(0.0f, _speed, Mathf.Abs(movement.forwardSpeed));
        ...
        protected virtual void UpdateRotation()
        {
            ...
            else
            {
                ...
                //rotate only upper part of player avatar towards mouse

                //Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition);
                //RaycastHit hitData;
                //if(Physics.Raycast(ray,out hitData, Mathf.Infinity,groundLayer)) {
                //    Vector3 target = new Vector3(hitData.point.x, transform.position.y, hitData.point.z);
                //    transform.LookAt(target);
                //    //RotateTowards(hitData.point);
                //}
            }
        }
        ...
        public virtual void Update()
        {
            ...
            if (Input.GetButtonDown("Jump")) animator.SetTrigger("kick");
            Animate();
        }
